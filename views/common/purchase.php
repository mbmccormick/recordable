<div class="row">
    <div class="span15">
        ...
        <form method="post" name="form" action="https://www.paypal.com/cgi-bin/webscr"> 
            <input type="hidden" name="notify_url" value="http://<?=$_SERVER['HTTP_HOST']?><?=option('base_uri')?>payment/<?=$conversation[sessioncode]?>" /> 
            ...
            <input type="hidden" name="return" value="http://<?=$_SERVER['HTTP_HOST']?><?=option('base_uri')?>play/<?=$conversation[sessioncode]?>" />
