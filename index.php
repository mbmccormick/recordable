...
<body>
  <table cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td colspan="2" valign="middle">
                    <form action="play.php" method="get">
                        ...
                        <input name="sessioncode" style="font-size: 28px; border: solid 1px #CCCCCC; width: 102px; text-align: center; font-family: Myriad Pro;" type="text" />
    ...
    <tr>
      <td colspan="5" valign="bottom" style="height: 200px;">
